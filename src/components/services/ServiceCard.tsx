...
interface ServiceCardProps {
  service: ServiceItem & { technologies?: string[]; glowColor?: string }
  isActive: boolean
  index: number
}
      ...
      <div className="w-full max-w-xl mx-auto px-6 lg:px-0">
        ...
        >
          <motion.span
            ...
            style={{
              background: `linear-gradient(135deg, ${service.glowColor?.replace('0.15', '0.08') || 'rgba(255,255,255,0.1)'}, transparent)`,
            }}
          />
