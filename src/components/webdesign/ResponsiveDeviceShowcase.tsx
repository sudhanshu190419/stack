...
const RESPONSIVE_PRINCIPLES = [
  {
    title: 'Fluid Layout Grids',
    desc: 'Multi-column proportional layouts that seamlessly reflow from 12-column desktop frames to single-column phone viewports without horizontal scroll bugs.',
  },
  {
...
export default function ResponsiveDeviceShowcase() {
  ...
  return (
    <>
      {/* ========================================================================= */}
      {/* MOBILE RESPONSIVE SHOWCASE (< lg)                                         */}
      {/* ========================================================================= */}
      <div className="block lg:hidden w-full">
        {/* Mobile Device Mockup Frame */}
        <div className="rounded-2xl border border-black/[0.09] bg-[#F5F2EC] p-3 sm:p-4">
          <div className="bg-white rounded-xl border border-black/[0.1] shadow-md overflow-hidden max-w-[320px] mx-auto">
            {/* Address Bar */}
            <div className="px-3 py-2 bg-[#FAF8F5] border-b border-black/[0.06] flex items-center justify-between gap-2">
              <div className="flex items-center gap-1 shrink-0">
                <span className="w-2 h-2 rounded-full bg-red-400/80" />
                <span className="w-2 h-2 rounded-full bg-amber-400/80" />
                <span className="w-2 h-2 rounded-full bg-emerald-400/80" />
              </div>
              <div className="flex items-center gap-1 px-2.5 py-0.5 rounded-full bg-white border border-black/[0.06] text-[10px] font-mono text-neutral-700 truncate shadow-2xs">
              ...
              <a
                ...
                className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full bg-neutral-900 text-white text-[9px] font-medium shrink-0"
              >
                <span>Live</span>
            ...
            {/* Mobile Scaled Iframe */}
            <div className="relative w-full h-[360px] overflow-hidden bg-neutral-50">
              <div
              ...
              >
                <iframe
                  ...
                  title="AnimalSathi Mobile Responsive Preview"
                  loading="eager"
        ...
        {/* 8 Principles in 2-Column Compact Grid */}
        <div className="grid grid-cols-2 gap-2.5 sm:gap-3 mt-6">
          {RESPONSIVE_PRINCIPLES.map((item, idx) => (
            <div
              key={item.title}
            ...
            >
              <div>
                ...
                <h4 className="text-xs sm:text-sm font-bold text-neutral-950 leading-snug mb-1">
                  {item.title}
                </h4>
      ...
      {/* ========================================================================= */}
      {/* DESKTOP RESPONSIVE SHOWCASE (>= lg) - 100% PRESERVED EXACT ORIGINAL       */}
      {/* ========================================================================= */}
