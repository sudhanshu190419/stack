  ...
  return (
    <>
      ...
      <main className="w-full bg-[#FAF7F2] text-neutral-900 pt-[72px] lg:pt-[80px]">
        {/* ─── 1. HERO SECTION ─── */}
        <section className="relative w-full overflow-hidden pt-6 sm:pt-8 lg:pt-12 pb-14 sm:pb-18 lg:pb-24 border-b border-black/[0.06]">
          ...
          <div className="max-w-[1560px] mx-auto px-6 sm:px-10 lg:px-14 xl:px-16 2xl:px-20">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-start">
              ...
              <div className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-2 gap-5 sm:gap-6">
                {[
                  {
                    icon: <ShieldCheck className="w-5 h-5 text-[#9E6941]" />,
                  ...
                  {
                    icon: <Compass className="w-5 h-5 text-[#9E6941]" />,
                  ...
                  {
                    icon: <Layout className="w-5 h-5 text-[#9E6941]" />,
                  ...
                  {
                    icon: <Target className="w-5 h-5 text-[#9E6941]" />,
        ...
        <section className="relative w-full py-16 sm:py-20 lg:py-24 border-b border-black/[0.06] bg-[#F5F1EA]/50">
          <div className="max-w-[1560px] mx-auto px-6 sm:px-10 lg:px-14 xl:px-16 2xl:px-20">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                {
                  icon: <Palette className="w-5 h-5 text-[#9E6941]" />,
                  title: 'UI Design',
                  desc: 'Crafting bespoke visual aesthetics: refined typography pairings, harmonious color tokens, elevation layers, and custom interface components that distinguish your brand.',
                },
                {
                  icon: <Users className="w-5 h-5 text-[#9E6941]" />,
                  title: 'UX Design',
                  desc: 'Architecting intuitive user journeys, customer journey maps, card sorting, and navigation wireframes that remove friction between visitor curiosity and conversion.',
                },
                {
                  icon: <Smartphone className="w-5 h-5 text-[#9E6941]" />,
                  title: 'Responsive Web Design',
                  desc: 'Designing fluid layouts engineered to adapt seamlessly across desktop, tablet, and mobile screens with thumb-friendly touch targets and proportional typography.',
                },
                {
                  icon: <Target className="w-5 h-5 text-[#9E6941]" />,
                  title: 'Landing Page Design',
                  desc: 'High-impact, focused campaign pages designed to maximize ad spend ROI through clear value propositions, trust proof, and distraction-free inquiry funnels.',
                },
                {
                  icon: <RefreshCw className="w-5 h-5 text-[#9E6941]" />,
                  title: 'Website Redesign',
                  desc: 'Modernizing outdated visual frameworks, fixing cluttered navigation, and repositioning legacy websites to reflect the true scale and quality of your current business.',
                },
                {
                  icon: <Layers className="w-5 h-5 text-[#9E6941]" />,
                  title: 'Design Systems',
                  desc: 'Building comprehensive Figma token libraries—standardized buttons, form inputs, typography hierarchies, and card modules—that streamline ongoing updates.',
                },
                {
                  icon: <Zap className="w-5 h-5 text-[#9E6941]" />,
                  title: 'Conversion-Focused Design',
                  desc: 'Structuring page elements based on real cognitive reading patterns (F-patterns, Z-patterns), social proof placement, and clear decision-making triggers.',
                },
                {
                  icon: <Sparkles className="w-5 h-5 text-[#9E6941]" />,
                  title: 'Interactive / Motion Design',
                  desc: 'Designing subtle micro-interactions, smooth scroll state reveals, and polished hover feedback that give the website a living, premium feel without lag.',
                },
              ].map((service, idx) => (
                <div
                  key={service.title}
              ...
              {[
                {
                  ...
                  body: 'We audit your existing digital footprint, research competitor positioning, analyze target customer personas, and define clear business conversion benchmarks.',
                },
                {
                  step: '02',
                  title: 'Information Architecture',
                  body: 'We map out the site map, URL taxonomy, content hierarchy, and page relationships to ensure visitors can reach any critical page in three clicks or fewer.',
                },
                {
                  step: '03',
                  title: 'Wireframes & User Journeys',
                  body: 'We build low-fidelity structural layouts focused strictly on information priority, content density, and user flow before introducing typography and color.',
                },
                {
                  step: '04',
                  title: 'Visual Design & Styling',
                  body: 'We develop bespoke art direction: typography scales, customized color palettes, micro-spacing grids, iconography, and high-fidelity page mockups.',
                },
                {
                  step: '05',
                  title: 'Interactive Prototype',
                  body: 'We connect screens in Figma into a clickable prototype, allowing your team to experience realistic navigation transitions, modals, and mobile menus before coding.',
                },
                {
                  step: '06',
                  title: 'Development Handoff',
                  body: 'We organize component tokens, export production-optimized assets, document responsive breakpoint rules, and provide interactive specs for engineering.',
                },
                {
                  step: '07',
                  title: 'Refinement & QA Signoff',
                  body: 'We conduct collaborative review sessions, gather stakeholder feedback, refine edge cases, and inspect the final build against the original design.',
                },
                {
                  step: '→',
                  title: 'Ready for Next.js Build',
                  body: 'Stack seamlessly transitions approved designs directly into production Next.js engineering with zero loss of visual fidelity or design intent.',
                  highlight: true,
                },
              ].map((stage) => (
                <div
        ...
        <section className="relative w-full py-16 sm:py-20 lg:py-24 border-b border-black/[0.06]">
          <div className="max-w-[1560px] mx-auto px-6 sm:px-10 lg:px-14 xl:px-16 2xl:px-20">
            ...
            {/* Interactive Breakpoint Showcase Component */}
                ...
                {[
                  {
                    ...
                    detail:
                      'Strict hierarchical type rules (Major Third or Perfect Fourth) balancing display serif headlines with ultra-legible body sans.',
                  },
                  {
                    title: 'Color & Contrast Tokens',
                    detail:
                      'Semantic color tokens (Primary, Surface, Text, Accent, Muted) calibrated for WCAG AA/AAA accessibility compliance.',
                  },
                  {
        ...
        <section className="relative w-full py-16 sm:py-20 lg:py-24 border-b border-black/[0.06] bg-[#F5F1EA]/50">
          <div className="max-w-[1560px] mx-auto px-6 sm:px-10 lg:px-14 xl:px-16 2xl:px-20">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                {
                  icon: <PenTool className="w-5 h-5 text-[#9E6941]" />,
                ...
                {
                  icon: <Grid className="w-5 h-5 text-[#9E6941]" />,
                ...
                {
                  icon: <Code2 className="w-5 h-5 text-[#9E6941]" />,
                ...
                {
                  icon: <FolderSync className="w-5 h-5 text-[#9E6941]" />,
                  title: 'In-House Studio Synergy',
                  desc: 'Because Stack houses both design and engineering teams under one roof, there is zero disconnect between creative vision and the final live website.',
                },
              ].map((step) => (
                <div
                  key={step.title}
