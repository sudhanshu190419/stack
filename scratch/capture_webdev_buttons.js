...
async function main() {
  ...
  try {
    ...
    fs.writeFileSync(path.join(artifactDir, 'webdev_mobile_new_buttons.png'), Buffer.from(scr.data, 'base64'));
    ...
    fs.writeFileSync(path.join(artifactDir, 'webdev_desktop_hero_verify.png'), Buffer.from(scr.data, 'base64'));
